...
| [k8s.io/apimachinery](https://github.com/kubernetes/apimachinery) | v0.33.1 | Apache-2.0 |
| [k8s.io/client-go](https://github.com/kubernetes/client-go) | v0.33.1 | Apache-2.0 |
...
| [github.com/hashicorp/hcl](https://github.com/hashicorp/hcl) | v1.0.0 | MPL-2.0 |
...
| [golang.org/x/sync](https://golang.org/x/sync) | v0.15.0 | BSD-3-Clause |
...
| [golang.org/x/text](https://golang.org/x/text) | v0.26.0 | BSD-3-Clause |
